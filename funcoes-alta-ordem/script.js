...
// a função é passa como parâmetro
...
// o segundo parâmetro não é um nvl, mas valor inicial, ou seja, sempre será considerado
...
// o sorte sobrepões o array original, por isso usamos o spread [...nomes] ao invés de nomes.sorte();
const s1 = [...nomes].sort();
console.log(s1);
